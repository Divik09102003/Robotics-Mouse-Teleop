...
class IncrementActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new IncrementFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = IncrementFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new IncrementActionFeedback(null);
    ...
    data.feedback = IncrementFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new IncrementActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = IncrementFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new IncrementFeedback()
    }
...
module.exports = IncrementActionFeedback;
