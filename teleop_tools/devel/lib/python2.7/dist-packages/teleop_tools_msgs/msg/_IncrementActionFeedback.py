...
"""autogenerated by genpy from teleop_tools_msgs/IncrementActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class IncrementActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "teleop_tools_msgs/IncrementActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','teleop_tools_msgs/IncrementFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IncrementActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = teleop_tools_msgs.msg.IncrementFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = teleop_tools_msgs.msg.IncrementFeedback()
