...
"""autogenerated by genpy from teleop_tools_msgs/IncrementAction.msg. Do not edit."""
import codecs
import sys
...
import genpy
import std_msgs.msg
import teleop_tools_msgs.msg

class IncrementAction(genpy.Message):
  _md5sum = "797aeed74214fd3316231275503262ab"
  _type = "teleop_tools_msgs/IncrementAction"
...
"""
  ...
  _slot_types = ['teleop_tools_msgs/IncrementActionGoal','teleop_tools_msgs/IncrementActionResult','teleop_tools_msgs/IncrementActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IncrementAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = teleop_tools_msgs.msg.IncrementActionGoal()
      if self.action_result is None:
        self.action_result = teleop_tools_msgs.msg.IncrementActionResult()
      if self.action_feedback is None:
        self.action_feedback = teleop_tools_msgs.msg.IncrementActionFeedback()
    else:
      self.action_goal = teleop_tools_msgs.msg.IncrementActionGoal()
      self.action_result = teleop_tools_msgs.msg.IncrementActionResult()
      self.action_feedback = teleop_tools_msgs.msg.IncrementActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_goal.goal.increment_by)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.increment_by))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.increment_by = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.action_goal.goal.increment_by.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      _x = self.action_result.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.increment_by = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      _x = self
      start = end
      end += 12
      (_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
