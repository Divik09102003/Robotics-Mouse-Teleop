...
"""autogenerated by genpy from teleop_tools_msgs/IncrementActionResult.msg. Do not edit."""
import codecs
import sys
...
class IncrementActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "teleop_tools_msgs/IncrementActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','teleop_tools_msgs/IncrementResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IncrementActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = teleop_tools_msgs.msg.IncrementResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = teleop_tools_msgs.msg.IncrementResult()
